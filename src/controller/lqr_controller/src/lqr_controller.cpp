...
controller_interface::CallbackReturn LQRController::on_init()
{
  try
  {
    ...
    auto_declare<std::string>("imu_topic",
                                          ...
                                          double& tp_right, StateOutputContributions& output_contributions)
{
  ...
  output_contributions.left_wheel_s_output = left_wheel_lqr_gains_[0] * s + left_wheel_lqr_gains_[1] * dot_s;
  output_contributions.left_wheel_fai_output = left_wheel_lqr_gains_[2] * fai + left_wheel_lqr_gains_[3] * dot_fai;
  output_contributions.left_wheel_theta_ll_output =
      left_wheel_lqr_gains_[4] * theta_ll + left_wheel_lqr_gains_[5] * dot_theta_ll;
  output_contributions.left_wheel_theta_lr_output =
      left_wheel_lqr_gains_[6] * theta_lr + left_wheel_lqr_gains_[7] * dot_theta_lr;
  output_contributions.left_wheel_theta_b_output =
      left_wheel_lqr_gains_[8] * theta_b + left_wheel_lqr_gains_[9] * dot_theta_b;

  // Calculate state output contributions for right wheel
  output_contributions.right_wheel_s_output = right_wheel_lqr_gains_[0] * s + right_wheel_lqr_gains_[1] * dot_s;
  output_contributions.right_wheel_fai_output = right_wheel_lqr_gains_[2] * fai + right_wheel_lqr_gains_[3] * dot_fai;
  ...
  output_contributions.left_leg_s_output = left_leg_lqr_gains_[0] * s + left_leg_lqr_gains_[1] * dot_s;
  output_contributions.left_leg_fai_output = left_leg_lqr_gains_[2] * fai + left_leg_lqr_gains_[3] * dot_fai;
  output_contributions.left_leg_theta_ll_output =
      left_leg_lqr_gains_[4] * theta_ll + left_leg_lqr_gains_[5] * dot_theta_ll;
  output_contributions.left_leg_theta_lr_output =
      left_leg_lqr_gains_[6] * theta_lr + left_leg_lqr_gains_[7] * dot_theta_lr;
  output_contributions.left_leg_theta_b_output =
      left_leg_lqr_gains_[8] * theta_b + left_leg_lqr_gains_[9] * dot_theta_b;

  // Calculate state output contributions for right leg
  output_contributions.right_leg_s_output = right_leg_lqr_gains_[0] * s + right_leg_lqr_gains_[1] * dot_s;
  output_contributions.right_leg_fai_output = right_leg_lqr_gains_[2] * fai + right_leg_lqr_gains_[3] * dot_fai;
  output_contributions.right_leg_theta_ll_output =
      right_leg_lqr_gains_[4] * theta_ll + right_leg_lqr_gains_[5] * dot_theta_ll;
  output_contributions.right_leg_theta_lr_output =
      right_leg_lqr_gains_[6] * theta_lr + right_leg_lqr_gains_[7] * dot_theta_lr;
  output_contributions.right_leg_theta_b_output =
      right_leg_lqr_gains_[8] * theta_b + right_leg_lqr_gains_[9] * dot_theta_b;
