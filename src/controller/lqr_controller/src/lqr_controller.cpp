...
void LQRController::calculate_lqr_control(double &wheel_torque_left,
                                          double &wheel_torque_right,
  ...
  wheel_torque_left =
      left_wheel_lqr_gains_[0] * s + left_wheel_lqr_gains_[1] * dot_s +
      left_wheel_lqr_gains_[2] * fai + left_wheel_lqr_gains_[3] * dot_fai +
      left_wheel_lqr_gains_[4] * theta_ll +
      left_wheel_lqr_gains_[5] * dot_theta_ll +
      left_wheel_lqr_gains_[6] * theta_lr +
      left_wheel_lqr_gains_[7] * dot_theta_lr +
      left_wheel_lqr_gains_[8] * (0.0 - theta_b) +
      left_wheel_lqr_gains_[9] * (0.0 - dot_theta_b);

  // Right wheel torque = K[10:19] * state (with polarity applied)
  wheel_torque_right =
      right_wheel_lqr_gains_[0] * s + right_wheel_lqr_gains_[1] * dot_s +
      right_wheel_lqr_gains_[2] * fai + right_wheel_lqr_gains_[3] * dot_fai +
      right_wheel_lqr_gains_[4] * theta_ll +
      right_wheel_lqr_gains_[5] * dot_theta_ll +
      right_wheel_lqr_gains_[6] * theta_lr +
      right_wheel_lqr_gains_[7] * dot_theta_lr +
      right_wheel_lqr_gains_[8] * (0.0 - theta_b) +
      right_wheel_lqr_gains_[9] * (0.0 - dot_theta_b);

  // Left leg torque (Tp) = K[20:29] * state (with polarity applied)
  tp_left = left_leg_lqr_gains_[0] * s + left_leg_lqr_gains_[1] * dot_s +
            left_leg_lqr_gains_[2] * fai + left_leg_lqr_gains_[3] * dot_fai +
            left_leg_lqr_gains_[4] * theta_ll +
            left_leg_lqr_gains_[5] * dot_theta_ll +
            left_leg_lqr_gains_[6] * theta_lr +
            left_leg_lqr_gains_[7] * dot_theta_lr +
            left_leg_lqr_gains_[8] * (0.0 - theta_b) +
            left_leg_lqr_gains_[9] * (0.0 - dot_theta_b);

  // Right leg torque (Tp) = K[30:39] * state (with polarity applied)
  tp_right = right_leg_lqr_gains_[0] * s + right_leg_lqr_gains_[1] * dot_s +
             right_leg_lqr_gains_[2] * fai + right_leg_lqr_gains_[3] * dot_fai +
             right_leg_lqr_gains_[4] * theta_ll +
             right_leg_lqr_gains_[5] * dot_theta_ll +
             right_leg_lqr_gains_[6] * theta_lr +
             right_leg_lqr_gains_[7] * dot_theta_lr +
             right_leg_lqr_gains_[8] * (0.0 - theta_b) +
             right_leg_lqr_gains_[9] * (0.0 - dot_theta_b);

  printf("theta_b output: %f, dot_theta_b output: %f\n", theta_b, dot_theta_b);
}
...
void LQRController::publish_lqr_state(double wheel_torque_left,
